...
#define TAG "LedStripControl(esp-spot-s3)"
...
LedStripControl::LedStripControl(CircularStrip* led_strip)
    ...
    mcp_server.AddTool(std::string("self.led_strip.set_brightness"),
        ...
        [this](const PropertyList& properties) -> ReturnValue {
            ...
            led_strip_->SetBrightness(LevelToBrightness(brightness_level_), 4);
            Settings settings(std::string("led_strip"), true);
            settings.SetInt("brightness", brightness_level_);
            return true;
        });

    mcp_server.AddTool(std::string("self.led_strip.set_single_color"),
    ...
    mcp_server.AddTool(std::string("self.led_strip.set_all_color"),
    ...
    mcp_server.AddTool(std::string("self.led_strip.blink"),
    ...
    mcp_server.AddTool(std::string("self.led_strip.scroll"),
